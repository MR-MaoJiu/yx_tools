...
class DateUtils {
  ...
  static String? formatDateString(String dateStr,
      {bool? isUtc, required String format}) {
    DateTime? time = getDateTime(dateStr, isUtc: isUtc);
    return time != null ? formatDate(time, format: format) : null;
  }
  ...
  static int getWeekNumber(DateTime date, {required int firstWeekday}) {
